...
You can download the data directly from here [🐰](https://mslivesfasu-my.sharepoint.com/:x:/g/personal/andradegp_sfasu_edu/EXhmCJ_BZM1GkT5s9UXFgnMB7V39VVAxg-OedGjmnqHR3Q?e=osgpdL)
...
The reports package can helps to do a general report of the model [@report] ( or at least understand a little of what you did 🙃).
...
pre_df <- newdata %>%
  mutate(
    ...
    prob     = plogis(fit_link),                          # predicción punto
    prob_low = plogis(fit_link - 1.96 * se_link),         # IC 95% inferior
    prob_high= plogis(fit_link + 1.96 * se_link)          # IC 95% superior
  )
```
...
Source code for this presentation can be found at : <https://gpandradep.github.io/Model-selection/>
